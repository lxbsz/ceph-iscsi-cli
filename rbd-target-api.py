...
def disk(image_id):
    ...
    **RESTRICTED**
    ...
    curl --insecure --user admin:admin -X GET https://192.168.122.69:5001/api/disk/rbd.new2_1
    curl --insecure --user admin:admin -X DELETE https://192.168.122.69:5001/api/disk/rbd.new2_1
    """
...
def get_clients():
    ...
    :param detail: (str) 'yes' to list details of all clients, default is 'no'
    **RESTRICTED**
    Examples:
    curl --insecure --user admin:admin -d detail='yes' -X GET https://192.168.122.69:5001/api/clients
    """
...
def clientauth(client_iqn):
    ...
    **RESTRICTED**
    Examples:
    curl --insecure --user admin:admin -d chap='' -X PUT https://192.168.122.69:5001/api/clientauth/iqn.2017-08.org.ceph:iscsi-gw0
    curl --insecure --user admin:admin -d chap=dmin1234/admin12345678 -X PUT https://192.168.122.69:5001/api/clientauth/iqn.2017-08.org.ceph:iscsi-gw0
    """
...
def clientlun(client_iqn):
    ...
    **RESTRICTED**
    Examples:
    curl --insecure --user admin:admin -d disk=rbd.new2_1 -X PUT https://192.168.122.69:5001/api/clientlun/iqn.2017-08.org.ceph:iscsi-gw0
    """
...
def client(client_iqn):
    ...
    **RESTRICTED**
    Examples:
    curl --insecure --user admin:admin -X PUT https://192.168.122.69:5001/api/client/iqn.1994-05.com.redhat:myhost4
    curl --insecure --user admin:admin -X DELETE https://192.168.122.69:5001/api/client/iqn.1994-05.com.redhat:myhost4
    """
...
def hostgroups():
    ...
    **RESTRICTED**
    Examples:
    curl --insecure --user admin:admin -X GET http://192.168.122.69:5001/api/hostgroups
    """
...
def hostgroup(group_name):
    ...
    **RESTRICTED**
    ...
    :return:
    Examples:
    curl --insecure --user admin:admin -X GET http://192.168.122.69:5001/api/hostgroup/group_name
    curl --insecure --user admin:admin -d members=iqn.1994-05.com.redhat:myhost4 -d disks=rbd.disk1 -X PUT http://192.168.122.69:5001/api/hostgroup/group_name
    curl --insecure --user admin:admin -d action=remove -d disks=rbd.disk1 -X PUT http://192.168.122.69:5001/api/hostgroup/group_name
    curl --insecure --user admin:admin -X DELETE http://192.168.122.69:5001/api/hostgroup/group_name
    """
    http_mode = 'https' if settings.config.api_secure else 'http'
